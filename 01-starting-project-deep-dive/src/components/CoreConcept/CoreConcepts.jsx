...
import CoreConcept from "./CoreConcept.jsx"; // Importing the CoreConcept component from the components directory.
...
export default CoreConcepts; // Exporting the CoreConcepts component to be used in other parts of the application.